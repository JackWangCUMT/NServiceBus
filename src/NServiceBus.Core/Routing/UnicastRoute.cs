namespace NServiceBus.Routing
{
    ...
    public class UnicastRoute : IUnicastRoute
    {
        ...
        async Task<IEnumerable<UnicastRoutingTarget>> IUnicastRoute.Resolve(Func<Endpoint, Task<IEnumerable<EndpointInstance>>> instanceResolver)
        {
            ...
            var instances = await instanceResolver(endpoint);
